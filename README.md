...
[Download extension](https://github.com/datenstrom/yellow-extensions/raw/master/downloads/wiki.zip) and copy zip file into your `system/extensions` folder. Right click if you use Safari.
